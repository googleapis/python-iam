...
class ListApplicablePoliciesPager:
    ...
    If there are more pages, the ``__iter__`` method will make additional
    ``ListApplicablePolicies`` requests and continue to iterate
    through the ``policies`` field on the
    corresponding responses.
    ...
    def __init__(
        self,
        method: Callable[..., policy.ListApplicablePoliciesResponse],
        request: policy.ListApplicablePoliciesRequest,
        response: policy.ListApplicablePoliciesResponse,
        *,
        metadata: Sequence[Tuple[str, str]] = ()
    ):
        """Instantiate the pager.
        ...
        """
        self._method = method
        self._request = policy.ListApplicablePoliciesRequest(request)
        self._response = response
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[policy.ListApplicablePoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, metadata=self._metadata)
...
class ListApplicablePoliciesAsyncPager:
    """A pager for iterating through ``list_applicable_policies`` requests.
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[policy.ListApplicablePoliciesResponse]],
        request: policy.ListApplicablePoliciesRequest,
        response: policy.ListApplicablePoliciesResponse,
        *,
        metadata: Sequence[Tuple[str, str]] = ()
    ...
    @property
    async def pages(self) -> AsyncIterator[policy.ListApplicablePoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
